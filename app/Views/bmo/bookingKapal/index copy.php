            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-lg-4">
                            ...
                            <select name="nama_kapal" id="nama_kapal" class="form-control" required>
                                ...
                                <?php foreach ($detailKapal as $d) : ?>
                                    <option value="<?= $d['dk_id']; ?>"><?= $d['dk_nama'] . " " . $d['dk_day']; ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        <div class="form-group col-lg-4">
                        ...
                        <div class="form-group col-lg-4">
                            <label for="jam_booking" class="form-label">Pilih Jam</label>
                            <select name="jam_booking" id="jam_booking" class="form-control text-center" required>
