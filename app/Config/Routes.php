...
$routes->post('customerDel', 'Customer::customerDel');
...
$routes->post('printBookingKapal', 'Kapal::printBookingKapal');
$routes->get('laporanBookingKapal', 'Kapal::laporanBookingKapal');
